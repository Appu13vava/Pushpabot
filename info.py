...
# Bot information
SESSION = environ.get('SESSION', 'PUsHPAFILIMFAKTORY')
API_ID = int(environ.get('API_ID', '15917107'))
API_HASH = environ.get('API_HASH', '8197e7638d58c92ae2504adba7c62117')
BOT_TOKEN = environ.get('BOT_TOKEN', "5736646811:AAHd14wQdFUlJfRJWCJmghH_KXv-SwtyA4M")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001921055290').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ald5i:RWXUp3JtogNRXBSh@cluster0.j4oucha.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001930977544'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'PUSHPA')

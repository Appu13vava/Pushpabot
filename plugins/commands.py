...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/+9hpzSIMAO_YyYjU9"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/+9hpzSIMAO_YyYjU9')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/+9hpzSIMAO_YyYjU9')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
